  ...
  <section id="banner">
    <div class="bg-color">
      ...
      <?php $args0 = array(
        ...
        'category_name' => 'slidercontent',
        'posts_per_page' => 2
      );


      $arr_posts = new WP_Query($args0);
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center marb-35">
          <h1 class="header-h"> <?php the_title(); ?></h1>
          <p class="header-p"><?php the_excerpt(); ?></p>
        </div>
      ...
      <div class="row">
        ...
        <div id="menu-wrapper">
          ...
          <div class="breakfast menu-restaurant">
            <span class="clearfix">
              <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg"><?php the_title(); ?></a>
              <span style="left: 166px; right: 44px;" class="menu-line"></span>
              <span class="menu-price"><?php echo get_post_meta($post->ID, 'Price', true); ?></span>
            </span>
            <span class="menu-subtitle"><?php the_excerpt(); ?></span>
          </div>
